...
export const sadhanaStrings = {
  ...
  adminKeyPlaceholder: '4-digit key',
  leaderboardTitle: 'साधना लीडरबोर्ड · पिछले 30 दिन',
  recordsLeaderboardTitle: 'लीडरबोर्ड · पिछले 30 दिन',
  leaderboardLoading: 'लोड हो रहा है…',
  leaderboardEmpty: 'इस अवधि में अभी कोई स्कोर नहीं।',
  leaderboardYourScore: 'आपका स्कोर',
  leaderboardRank: 'रैंक',
  leaderboardDays: 'दिन',
  leaderboardNoScore: 'पिछले 30 दिनों में स्कोर योग्य प्रविष्टि नहीं',
